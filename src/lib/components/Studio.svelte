...
<div bind:this={studio}
	...
	class="font-clash-display font-semibold flex text-primary flex-col h-fit items-center justify-between mx-auto mt-12 lp:mt-0"
>
    <div class="flex flex-col justify-center flex-grow items-center font-medium">
