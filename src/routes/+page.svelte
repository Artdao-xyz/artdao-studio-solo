...
<div class="bg-background h-screen flex flex-col items-center justify-center max-w-screen  z-30 dp:max-w-[1440px] dp:mx-auto">

    <div class="flex flex-col items-center justify-between rounded-xl h-[95%] -4 lp:py-4 lp:px-14 shadow-custom">
